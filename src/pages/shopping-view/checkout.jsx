            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5 p-5">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col items-center mt-8">
                        <img src={paytmQR} alt="Paytm QR" className="w-full max-w-[200px] sm:max-w-[250px] md:max-w-[300px]" />
                        <p className="mt-2 text-2xl">SCAN TO PAY</p>
                        <a
                            href="https://forms.gle/1uiUdFyswMnNng8z8D"
                            target="_blank"
                    ...
                    <div className="mt-4 w-full">
                        <Button onClick={handleInitiatePaypalPayment} className="w-full">Confirm Order</Button>
                    </div>
                </div>
            </div>
        </div>
